...
if __name__ == "__main__":  
    ...
    if Create:
        ...
        for stkcode in stkcodes:        
            ...
            """
            AutoStrategy.Machine_Learning_Create(TimestampPriceX=TimestampPriceX, strategyfolder='C:\\Users\\laoya\\Desktop\\ZM', code=stkcode,numfeature=5,numtry=500)
    ...
    if Deploy:   
        ...
        '''
        AutoStrategy.Deploy(strategy='Auto_2018_10_17_14_46_14_QI000032',strategyfolder='C:\\Users\\laoya\\Desktop\\ZM',vtSymbol='IC1810',vnpypath='C:\\Users\\laoya\\Desktop\\vnpy安装\\vnpy-master\\vnpy-master',mock=False)
    ...
    if Trading:
        ...
        def Trading(strategyName):
            ...
            if ((time_in_range(datetime.time(9,31,0),datetime.time(11,30,0),TimeNow)) or (time_in_range(datetime.time(13,00,0),datetime.time(15,0,0),TimeNow))):
                if (TimeNow.minute % 30==1):
                    ...
                    signalpath: 交易信号写入的数据库，若None则默认在strategyfolder向上一级文件夹下
                    '''
                    AutoStrategy.Machine_Learning_Run(strategy='Auto_2018_10_17_14_46_14_QI000032',strategyfolder='C:\\Users\\laoya\\Desktop\\ZM',vtSymbol=None,Newdata=Newdata)
        ...
        strategyName='Auto_2018_10_17_14_46_14_QI000032'
