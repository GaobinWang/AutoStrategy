...
if __name__ == "__main__":  
    ...
    if not Trading:
        ...
        """
        strategyName=AutoStrategy.create(TimestampPriceX=TimestampPriceX, strategyfolder='C:\\Users\\maozh\\Desktop\\Work\\StartegyFolder', code='SH000905',numfeature=5,numtry=500)
        ...
        def Trading(strategyName):
            ...
            if ((time_in_range(datetime.time(9,31,0),datetime.time(11,30,0),TimeNow)) or (time_in_range(datetime.time(13,00,0),datetime.time(15,0,0),TimeNow))):
                if (TimeNow.minute % 30==1):
                    ...
                    signalpath: 交易信号写入的数据库，若None则默认在strategyfolder向上一级文件夹下
                    '''
                    AutoStrategy.run(strategy=strategyName,strategyfolder='C:\\Users\\maozh\\Desktop\\Work\\StartegyFolder',vtSymbol='IC1810',Newdata=Newdata)
